...
export const columns: ColumnDef<SalaryDetails>[] = [
  ...
  },
  {
    ...
    header: "Advance",
    cell: ({ row }) => <span className="text-destructive">{formatCurrency(row.original.advanceDeduction)}</span>,
  },
  {
    accessorKey: "absenceDeduction",
    header: "Absence",
    cell: ({ row }) => <span className="text-destructive">{formatCurrency(row.original.absenceDeduction)}</span>,
  },
  {
    accessorKey: "netSalary",
    header: "Net Salary",
    cell: ({ row }) => <span className="font-bold">{formatCurrency(row.original.netSalary)}</span>,
  },
  {
    id: 'actions',
    cell: () => (
...
export default function SalaryPage() {
  const [data] = React.useState(() => [...salaryDetails]);
